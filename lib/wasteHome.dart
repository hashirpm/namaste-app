      ...
      body: Center(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              getImageCard(context, "images/bio-waste.png", "Bio-waste"),
              getImageCard(context, "images/e-waste.png", "E-waste")
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              getImageCard(context, "images/plas.png", "Plastic waste"),
              getImageCard(context, "images/agri.png", "Agricultural waste")
            ],
          ),
          Row(
