                      ...
                      Container(
                        ...
                        child: GridView.count(
                          ...
                          children: <Widget>[
                           ...
                           Provider.of<UserProvider>(context).userData.isAdmin==false?  InkWell(
                              onTap: () {
                                utils.showAlert(
                                    errMsgL1: "Are you sure you want to register as Volunteer?",
                                    function: () async {
                                      ...
                                      await userProvider.makeAdmin(id: uid);
                                    });
                              },
                              child:  ContentCard(
